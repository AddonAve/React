...
React 1.6.0.0 - added in $ACTORID variable to use in a reaction. Useful for sending helper lua's commands about the actor that performed the action. Replaces $ACTORID with the ID of the actor.

React 1.7.0 - only reacts to targets that are claimed by self or party **Addon Ave modification**
